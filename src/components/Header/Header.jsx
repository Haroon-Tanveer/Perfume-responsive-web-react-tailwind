...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setIsScrolled(window.scrolY > 10);
    };
      ...
      >
        <div className="max-x-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6">
            ...
            <div className="w-full md:flex-1 max-w-sm rounded-sm rounded-xs">
              <div className="relative w-full rounded-xs">
                <input
                  type="text"
                  placeholder="Search"
                  className="w-full px-3 py-2 text-xs border rounded-xl border-gray-300 rounde-full focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
                <button
                  className="absolute right-2 top-1/2 cursor-pointer -translate-y-1/2 text-gray-500 hover:text-indigo-700"
            ...
            <div className="flex items-center justify-end space-x-4 w-full md:w-auto">
              <button
                className="relative p-2 cursor-pointer text-gray-700 hover:text-pink-600"
                aria-label="Wishlist"
              >
                <FiHeart size={20} />
              ...
              <button
                className="p-2 text-gray-700 cursor-pointer hover:text-600"
                aria-label="User"
              >
                <FiUser size={20} />
              </button>
