...
const Offers = () => {
  const currentOffers = [
    ...
    },
    {
      ...
      discount:'Gift',
      description:
        "Get a free perfume when you buy two products from our luxuary brands",
      endDate: "2030-05-15",
      code: "FREEPERFUME",
    ...
    <section id="offers" className="container scroll-mt-20 mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {currentOffers.map((offer) => (
          <div
            key={offer.id}
            className={`${offer.bgColor} rounded-xl shadow-lg overflow-hidden transform duration-300 hover:scale-105`}
          >
            <div className="p-6">
