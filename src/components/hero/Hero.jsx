...
const Hero = () => {
  return (
    <section id="home" className="bg-amber-50 scroll-mt-20 py-16">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 flex flex-col-reverse lg:flex-row items-center gap-10">
        <div className="text-center lg:text-left max-w-xl">
          <h1 className="text-4xl sm:text-5xl font-bold text-amber-950 leading-light mb-4">
            Discover The Best Deals on Top Products
          </h1>
          <p className="text-gray-700 text-base sm:text-lg mb-6">
            Perfume is a silent <b>signature</b> an invisible accessory that lingers,
            evokes memories, and speaks before words. Just a drop can capture a
            mood, a moment, or a memory, making it uniquely yours.
          </p>
